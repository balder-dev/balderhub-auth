...
from tests.lib.setup_features.client.unresolved_param_config import UnresolvedParamConfig
...
class SetupUnresolvedResources(balder.Setup):
    ...
    class Client(balder.Device):
        ...
        param_provider = UnresolvedParamConfig()
